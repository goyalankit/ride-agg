...
class TestMeruService(ServiceTester):
    @property
    def service(self):
        return MeruService
    ...
    def test_rule_for_given_time(self):
        ...
        s_rule = self.get_rule_for_given_time(rules, time_to_check)
